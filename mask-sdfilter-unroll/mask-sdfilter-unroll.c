...
int main(int argc, char **argv)
{
  ...
  double m0 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m1 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m2 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m3 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m4 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m5 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m6 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m7 = ((double)rand()/(double)(RAND_MAX)) * 1.0;
  double m8 = ((double)rand()/(double)(RAND_MAX)) * 1.0;

  printf("attempting to create kernel\n");
  fflush(stdout);
	kernel = CL_CHECK_ERR(clCreateKernel(program, "mask_sdfilter_unroll", &_err));
